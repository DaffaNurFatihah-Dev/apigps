...
//   }
  ...
  public function save($data)
  {
    ...
    $this->db->insert('arduino.arduino_moulding_component', $data);
  ...
  public function monitoring()
  {
    $data = $this->db->order_by('id', 'desc')
      ->limit(100)
      ->get('arduino.arduino_moulding_component')->result_array();
    return $data;
  }
  ...
  public function getFirstData()
  {
      ...
      $query = $this->db->get('arduino.arduino_moulding_component', 1);
  ...
  public function getById($id)
  {
    ...
    return $this->db->get_where('arduino.arduino_moulding_component', ['id' => $id])->row_array();
  }
  ...
  public function update($id, $data)
  {
    ...
    $this->db -> where ('id', $data['id'])
      ->update('arduino.arduino_moulding_component', $data);
